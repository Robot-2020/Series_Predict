...
class ModelDecomp(object):
    ...
    def decomp(self, period):
        '''
        对时间序列进行分解
        :param period: 周期
        '''
        decomposition = seasonal_decompose(self.train, period=period, two_sided=False)
    ...
    def predict_new(self):
        ...
        n = self.test_size
        self.pred_time_index= pd.date_range(start=self.train.index[-1], periods=n+1, period='1min')[1:]
